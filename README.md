...
| Gaudry-Schost | `GaudrySchostSixSet`           | Six-set with parity seperation (double wild sets samples)             | 1.565 ($\alpha = \frac{1}{64}$), 1.557 ($\alpha \to 0^{+}$) | 
...
| Gaudry-Schost | `GaudrySchostSotaV2`           | Smaller tame set plus wild-wild collisions, same wild set parity      |                                1.128 ($\alpha=\frac{1}{8}$) |
...
| SOTA v2                  | `GaudrySchostSotaV2`         | $\alpha = \frac{1}{8}$  |         1.128 |   1.129 |   0.620 | [1.123, 1.136] |    1.047 |
| SOTA v2                  | `GaudrySchostSotaV2`         | $\alpha = \frac{1}{64}$ |         1.107 |   1.108 |   0.597 | [1.101, 1.114] |    1.033 |
