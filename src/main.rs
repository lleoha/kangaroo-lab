...
use kangaroo_lab::dlp::method::gaudry_schost::{
    ...
    GaudrySchostSotaV2, GaudrySchostSotaV2Overhead, GaudrySchostSotaV2Plus, GaudrySchostThreeSet,
};
...
const DEFAULT_RANGE_BITS: u32 = 40;
...
fn main() {
    ...
    let jobs = vec![
        ...
        // ),
        Job::new::<ToyGroup>(
            "REAL SOTAv2 (a = 1/64, c = 1/4, dp = 8, jt = 9)",
            GaudrySchostSotaV2Overhead::new_unchecked(1.0 / 16.0, 16.0, 8, 8),
            samples,
            &multi_progress,
            &progress_style,
        ),
